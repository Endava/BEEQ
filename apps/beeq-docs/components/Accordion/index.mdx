...
<Frame className="px-4 py-4" caption="Accordion component overview">
  <img className="block dark:hidden" src="./images/accordion-overview-light.svg" />
  <img className="hidden dark:block" src="./images/accordion-overview-dark.svg" />
</Frame>
...
<Frame caption="Accordion anatomy">
  <img className="block dark:hidden" src="./images/accordion-anatomy-light.svg" alt="Accordion anatomy" />
  <img className="hidden dark:block" src="./images/accordion-anatomy-dark.svg" alt="Accordion anatomy" />
</Frame>
