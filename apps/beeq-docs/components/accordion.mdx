...
<Frame className="px-4 py-4" caption="Accordion component overview">
  <img className="block dark:hidden" src="./images/accordion/accordion-overview-light.svg" />
  <img className="hidden dark:block" src="./images/accordion/accordion-overview-dark.svg" />
</Frame>
...
- **Related components:** Use [tabs](/components/tabs) when content belongs to a small set of peer views, or a simple show/hide pattern when only one section needs to expand.
...
<Frame caption="Accordion anatomy">
  <img className="block dark:hidden" src="./images/accordion/accordion-anatomy-light.svg" alt="Accordion anatomy" />
  <img className="hidden dark:block" src="./images/accordion/accordion-anatomy-dark.svg" alt="Accordion anatomy" />
</Frame>
...
The `filled` appearance adds a background color to the header, giving accordions a contained look. This is the default.

<Tip>
  Since the default value of the `appearance` attribute/property is `filled`, there's no need to explicitly set it on the component when you want to use the filled appearance.
</Tip>

<CodeLivePreview code={`
  <bq-accordion appearance="filled" expanded>
    <span slot="header">Filled accordion</span>
    <p>This accordion uses the default filled appearance.</p>
  </bq-accordion>
`}>
  <CodeGroup>
    ```html HTML icon="html5"
    ...
    <BqAccordion appearance="filled" expanded>
      <span slot="header">Filled accordion</span>
      <p>This accordion uses the default filled appearance.</p>
    </BqAccordion>
    ```
...
The `ghost` appearance removes the header background, presenting a minimal, borderless look that blends with the surrounding content.

<CodeLivePreview code={`
  <bq-accordion appearance="ghost" expanded>
    <span slot="header">Ghost accordion</span>
    <p>This accordion uses the ghost appearance — no background on the header.</p>
  </bq-accordion>
`}>
  <CodeGroup>
    ```html HTML icon="html5"
...
Use `expand-all` on the group to open every accordion at once — useful for print views or when people need to scan all content.
...
Use the `prefix` slot to add an icon before the header text, providing a visual cue about the section's content.
...
The `prefix` slot also accepts an avatar, useful for person-related sections such as profiles or team members.
...
<CodeLivePreview code={`
  <bq-accordion>
    <bq-avatar
      ...
      slot="prefix"
    ></bq-avatar>
    <span slot="header">With avatar</span>
    <p>The header includes an avatar in the prefix slot.</p>
  </bq-accordion>
`}>
  <CodeGroup>
    ```html HTML icon="html5"
    ...
    ```jsx React icon="react"
    import { BqAccordion, BqAvatar } from "@beeq/react";
    ...
    ```vue Vue icon="vuejs"
    <script setup lang="ts">
    import { BqAccordion, BqAvatar } from "@beeq/vue";
    </script>
...
Use the `suffix` slot to add an icon after the header text, for example a settings gear or status indicator.
...
Developers can [rely on the exposed shadow DOM parts](https://www.beeq.design/3d466e231/p/6733bc) of the components to target elements inside it and tweak not only the look & feel but also the layout.
...
<Expandable title="View all CSS variables" defaultOpen={false}>
  ...
  | ------------------------------------------ | ------------------------------------------------- | ---------------------------- |
  | `--bq-accordion--small-padding-y`          | Small vertical padding                            | `theme('spacing.xs')`        |
  | `--bq-accordion--small-padding-start`      | Small start padding                               | `theme('spacing.s')`         |
  | `--bq-accordion--small-padding-end`        | Small end padding                                 | `theme('spacing.s')`         |
  | `--bq-accordion--small-gap`                | Small gap between prefix, title, and suffix       | `theme('spacing.xs')`        |
  | `--bq-accordion--small-radius`             | Small border radius                               | `theme('borderRadius.xs')`   |
  | `--bq-accordion--medium-padding-y`         | Medium vertical padding                           | `theme('spacing.s')`         |
  | `--bq-accordion--medium-padding-start`     | Medium start padding                              | `theme('spacing.m')`         |
  | `--bq-accordion--medium-padding-end`       | Medium end padding                                | `theme('spacing.m')`         |
  | `--bq-accordion--medium-gap`               | Medium gap between prefix, title, and suffix      | `theme('spacing.m')`         |
  | `--bq-accordion--medium-radius`            | Medium border radius                              | `theme('borderRadius.xs')`   |
  ...
  | Variable                                              | Description                                | Default                          |
  | ----------------------------------------------------- | ------------------------------------------ | -------------------------------- |
  | `--bq-accordion--filled-collapsed-background`         | Filled collapsed header background         | `theme('colors.ui.secondary')`   |
  | `--bq-accordion--filled-collapsed-text-color`         | Filled collapsed header text color         | `theme('colors.text.primary')`   |
  | `--bq-accordion--filled-expanded-background`          | Filled expanded header background          | `theme('colors.ui.brand-alt')`   |
  | `--bq-accordion--filled-expanded-text-color`          | Filled expanded header text color          | `theme('colors.text.primary')`   |
  ...
  | `--bq-accordion--ghost-collapsed-text-color`          | Ghost collapsed header text color          | `theme('colors.text.primary')`   |
  | `--bq-accordion--ghost-expanded-background`           | Ghost expanded header background           | `transparent`                    |
  | `--bq-accordion--ghost-expanded-text-color`           | Ghost expanded header text color           | `theme('colors.text.brand')`     |

  #### Panel — filled

  | Variable                                              | Description                                | Default                          |
  | ----------------------------------------------------- | ------------------------------------------ | -------------------------------- |
  | `--bq-accordion--panel-filled-border-color`           | Filled panel border color                  | `theme('colors.stroke.primary')` |
  | `--bq-accordion--panel-filled-border-style`           | Filled panel border style                  | `solid`                          |
  | `--bq-accordion--panel-filled-border-width`           | Filled panel border width                  | `1px`                            |
  | `--bq-accordion--panel-small-filled-padding-y`        | Small filled panel vertical padding        | `theme('spacing.s')`             |
  | `--bq-accordion--panel-small-filled-padding-start`    | Small filled panel start padding           | `theme('spacing.s')`             |
  | `--bq-accordion--panel-small-filled-padding-end`      | Small filled panel end padding             | `theme('spacing.s')`             |
  | `--bq-accordion--panel-medium-filled-padding-y`       | Medium filled panel vertical padding       | `theme('spacing.m')`             |
  | `--bq-accordion--panel-medium-filled-padding-start`   | Medium filled panel start padding          | `theme('spacing.m')`             |
  | `--bq-accordion--panel-medium-filled-padding-end`     | Medium filled panel end padding            | `theme('spacing.m')`             |

  #### Panel — ghost

  | Variable                                              | Description                                | Default                          |
  | ----------------------------------------------------- | ------------------------------------------ | -------------------------------- |
  | `--bq-accordion--panel-ghost-border-color`            | Ghost panel border color                   | `theme('colors.stroke.primary')` |
  | `--bq-accordion--panel-ghost-border-style`            | Ghost panel border style                   | `solid`                          |
  | `--bq-accordion--panel-ghost-border-width`            | Ghost panel border width                   | `1px`                            |
  | `--bq-accordion--panel-small-ghost-padding-y`         | Small ghost panel vertical padding         | `theme('spacing.s')`             |
  | `--bq-accordion--panel-small-ghost-padding-start`     | Small ghost panel start padding            | `theme('spacing.s')`             |
  | `--bq-accordion--panel-small-ghost-padding-end`       | Small ghost panel end padding              | `theme('spacing.s')`             |
  | `--bq-accordion--panel-medium-ghost-padding-y`        | Medium ghost panel vertical padding        | `theme('spacing.m')`             |
  | `--bq-accordion--panel-medium-ghost-padding-start`    | Medium ghost panel start padding           | `theme('spacing.m')`             |
  | `--bq-accordion--panel-medium-ghost-padding-end`      | Medium ghost panel end padding             | `theme('spacing.m')`             |

  #### Group

  | Variable                         | Description                           | Default              |
  | -------------------------------- | ------------------------------------- | -------------------- |
  | `--bq-accordion-group--gap`      | Gap between accordion items in a group | `theme('spacing.xs')` |
