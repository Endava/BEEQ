...
<Frame className="px-4 py-4" caption="Accordion component overview">
  <img className="block dark:hidden" src="/components/images/accordion/accordion-overview-light.svg" />
  <img className="hidden dark:block" src="/components/images/accordion/accordion-overview-dark.svg" />
</Frame>
