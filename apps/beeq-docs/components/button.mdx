...
<Frame className="px-4 py-4" caption="Button component overview">
  <img className="block dark:hidden" src="./images/button/button-overview-light.svg" alt="BEEQ Button component overview" />
  <img className="hidden dark:block" src="./images/button/button-overview-dark.svg" alt="BEEQ Button component overview" />
</Frame>
...
<Frame caption="Button anatomy">
  <img src="./images/button/button-anatomy.svg" alt="Button anatomy: 1. Container, 2. Icon, 3. Label" />
</Frame>
...
<Frame caption="Button states: enabled, hover, focus, active, loading, disabled">
  <img src="./images/button/button-states.svg" alt="Button states: enabled, hover, focus, active, loading, disabled" />
</Frame>
