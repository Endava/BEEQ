...
<Frame className="px-4 py-4" caption="Button component overview">
  <img className="block dark:hidden" src="./images/button-overview-light.svg" alt="BEEQ Button component overview" />
  <img className="hidden dark:block" src="./images/button-overview-dark.svg" alt="BEEQ Button component overview" />
</Frame>
...
<Note>
  Use a link button for navigation when the intent is simply to move to another page. See the [Link](#link) variant.
</Note>
...
<Frame caption="Button anatomy">
  <img src="./images/button-anatomy.svg" alt="Button anatomy: 1. Container, 2. Icon, 3. Label" />
</Frame>
...
For each button appearance and variant, there are five visual states: **enabled**, **hover**, **active**, **focus**, and **disabled**.

<Frame caption="Button states across all variants">
  <img src="./images/button-states.svg" alt="Button states: enabled, hover, active, focus, disabled" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card horizontal title="Source code" icon="github" href="https://github.com/nicobees/BEEQ/tree/main/packages/beeq/src/components/button">
