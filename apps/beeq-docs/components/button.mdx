...
<CodeLivePreview mode="shadow" code={`<bq-button appearance="secondary">Secondary</bq-button>\n<bq-button appearance="secondary" variant="ghost">Secondary ghost</bq-button>`}>
  <CodeGroup>
    ```html HTML icon="html5"
...
<CodeLivePreview mode="shadow" code={`<bq-button block>Full width button</bq-button>`}>
  <CodeGroup>
    ```html HTML icon="html5"
...
<CodeLivePreview mode="shadow" code={`<bq-button loading>Loading</bq-button>\n<bq-button loading disabled>Loading disabled</bq-button>`}>
  <CodeGroup>
    ```html HTML icon="html5"
