...
<Frame className="px-4 py-4" caption="Card component anatomy">
  <img className="block dark:hidden" src="/components/images/card/card-anatomy-light.svg" alt="BEEQ Card component anatomy" />
  <img className="hidden dark:block" src="/components/images/card/card-anatomy-dark.svg" alt="BEEQ Card component anatomy" />
</Frame>
