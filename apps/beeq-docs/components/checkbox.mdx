...
<CodeLivePreview code={`<bq-checkbox name="updates" value="updates">
  ...
  <CodeGroup>
    ...
    <!-- Standalone: import { BqCheckbox } from "@beeq/angular/standalone" -->
...
>
  <CodeGroup>
    ...
    <BqCheckbox className="checkbox-long" name="terms" value="terms">
      By clicking here, I state that I have read and understood the terms and conditions.
    </BqCheckbox>
    ```
    ...
    <template>
      <BqCheckbox class="checkbox-long" name="terms" value="terms">
        By clicking here, I state that I have read and understood the terms and conditions.
      </BqCheckbox>
    </template>
    ```
...
<CodeLivePreview code={`<bq-checkbox name="notifications" value="notifications" background-on-hover>
...
<CodeLivePreview
  code={`<bq-checkbox checked name="newsletter" value="newsletter">
...
<CodeLivePreview
  ...
  <script>
    (async () => {
      ...
      await customElements.whenDefined('bq-checkbox');
      ...
      await Promise.all([
        allInterestCheckbox.componentOnReady?.(),
        ...interestCheckboxes.map((checkbox) => checkbox.componentOnReady?.()),
      ]);
...
>
  <CodeGroup>
    ...
    <div>
      <bq-checkbox
        background-on-hover
        [checked]="music && travel && sport"
        [indeterminate]="(music || travel || sport) && !(music && travel && sport)"
        name="all-interests"
        value="all"
        (bqChange)="music = $event.detail.checked; travel = $event.detail.checked; sport = $event.detail.checked"
      >
        Interests
      </bq-checkbox>
      ...
      <div class="checkbox-group__children">
        <bq-checkbox
          ...
          name="interest"
          value="music"
          (bqChange)="music = $event.detail.checked"
        >
          Music
        </bq-checkbox>
        <bq-checkbox
          ...
          name="interest"
          value="travel"
          (bqChange)="travel = $event.detail.checked"
        >
          Travel
        </bq-checkbox>
        <bq-checkbox
          ...
          name="interest"
          value="sport"
          (bqChange)="sport = $event.detail.checked"
        >
          Sport
        </bq-checkbox>
      </div>
...
<Expandable title="CSS variables" defaultOpen={true}>
  ...
  | `--bq-checkbox--border-radius` | Checkbox border radius | `theme(borderRadius.xs)` |
  | `--bq-checkbox--border-width` | Checkbox border width | `theme(borderWidth.m)` |
</Expandable>
