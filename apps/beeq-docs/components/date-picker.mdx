...
<CodeLivePreview code={`
  ...
  <bq-date-picker name="date-error" validation-status="error" value="2026-05-25">
    <label class="flex flex-grow items-center" slot="label">Error date</label>
  </bq-date-picker>

  <bq-date-picker name="date-success" validation-status="success" value="2026-06-25">
    <label class="flex flex-grow items-center" slot="label">Success date</label>
  </bq-date-picker>

  <bq-date-picker name="date-warning" validation-status="warning" value="2026-07-25">
    <label class="flex flex-grow items-center" slot="label">Warning date</label>
  </bq-date-picker>
`}>
  <CodeGroup>
    ```html HTML icon="html5"
    ...
    <>
      <BqDatePicker name="date-error" validationStatus="error" value="2026-05-25">
        <label className="flex flex-grow items-center" slot="label">Error date</label>
      </BqDatePicker>

      <BqDatePicker name="date-success" validationStatus="success" value="2026-06-25">
        <label className="flex flex-grow items-center" slot="label">Success date</label>
      </BqDatePicker>

      <BqDatePicker name="date-warning" validationStatus="warning" value="2026-07-25">
        <label className="flex flex-grow items-center" slot="label">Warning date</label>
      </BqDatePicker>
    </>
    ```
...
`}>
  <CodeGroup>
    ...
    <BqDatePicker name="arrival-date" value="2026-08-10">
      <div slot="label">
        <label className="flex flex-grow items-center">Arrival date</label>
        <span>Optional</span>
      </div>
    </BqDatePicker>
    ```
...
<CodeLivePreview code={`
  ...
  <bq-date-picker locale="en-GB" name="locale-gb" value="2026-10-13">
    <label class="flex flex-grow items-center" slot="label">en-GB</label>
  </bq-date-picker>

  <bq-date-picker locale="en-US" name="locale-us" value="2026-10-13">
    <label class="flex flex-grow items-center" slot="label">en-US</label>
  </bq-date-picker>

  <bq-date-picker locale="ja-JP" name="locale-jp" value="2026-10-13">
    <label class="flex flex-grow items-center" slot="label">ja-JP</label>
  </bq-date-picker>
`}>
  <CodeGroup>
    ```html HTML icon="html5"
    ...
    <>
      <BqDatePicker locale="en-GB" name="locale-gb" value="2026-10-13">
        <label className="flex flex-grow items-center" slot="label">en-GB</label>
      </BqDatePicker>

      <BqDatePicker locale="en-US" name="locale-us" value="2026-10-13">
        <label className="flex flex-grow items-center" slot="label">en-US</label>
      </BqDatePicker>

      <BqDatePicker locale="ja-JP" name="locale-jp" value="2026-10-13">
        <label className="flex flex-grow items-center" slot="label">ja-JP</label>
      </BqDatePicker>
    </>
    ```
...
<CodeLivePreview code={`
  ...
  <bq-date-picker first-day-of-week="1" locale="en-GB" name="week-monday" value="2026-10-13">
    <label class="flex flex-grow items-center" slot="label">Monday first</label>
  </bq-date-picker>

  <bq-date-picker first-day-of-week="0" locale="en-GB" name="week-sunday" value="2026-10-13">
    <label class="flex flex-grow items-center" slot="label">Sunday first</label>
  </bq-date-picker>
`}>
  <CodeGroup>
    ```html HTML icon="html5"
    ...
    <>
      <BqDatePicker firstDayOfWeek={1} locale="en-GB" name="week-monday" value="2026-10-13">
        <label className="flex flex-grow items-center" slot="label">Monday first</label>
      </BqDatePicker>

      <BqDatePicker firstDayOfWeek={0} locale="en-GB" name="week-sunday" value="2026-10-13">
        <label className="flex flex-grow items-center" slot="label">Sunday first</label>
      </BqDatePicker>
    </>
    ```
...
<CodeLivePreview code={`
  ...
  <bq-date-picker name="outside-visible" open show-outside-days value="2026-05-12">
    <label class="flex flex-grow items-center" slot="label">With outside days</label>
  </bq-date-picker>
`}>
  <CodeGroup>
    ```html HTML icon="html5"
    ...
    <BqDatePicker name="outside-visible" open showOutsideDays value="2026-05-12">
      <label className="flex flex-grow items-center" slot="label">With outside days</label>
    </BqDatePicker>
    ```
...
<CodeLivePreview code={`
  ...
  <bq-date-picker
    ...
    value="2026-11-18"
  >
    <label class="flex flex-grow items-center" slot="label">Meeting date</label>
  </bq-date-picker>
...
`}>
  <CodeGroup>
    ...
    <BqDatePicker
      ...
      value="2026-11-18"
    >
      <label className="flex flex-grow items-center" slot="label">Meeting date</label>
    </BqDatePicker>
    ```
...
<Expandable title="CSS variables" defaultOpen={false}>
  ...
  | `--bq-date-picker--border-color-focus` | Border color on focus | `--bq-focus` (brand focus ring token) |
