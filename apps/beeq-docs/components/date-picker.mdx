...
<Note>
  ...
  A custom `placeholder` is preserved when you provide one. Omit it when you want the mask itself to orient users before they start typing. The expected mask is also exposed to assistive technology.
</Note>
