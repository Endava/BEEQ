...
Dialogs help people stay in context while responding to important information, confirming an action, or completing a short focused task. Use them sparingly, and only when the interruption is justified.
