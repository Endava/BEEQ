...
<CodeLivePreview
  ...
  <script>
    (() => {
      ...
      const dialog = preview.querySelector('bq-dialog');
      const openButton = preview.querySelector('bq-button');
...
<CodeLivePreview
  ...
  <script>
    (() => {
      ...
      const dialog = preview.querySelector('bq-dialog');
      const openButton = preview.querySelector('bq-button[variant="ghost"]');
      const cancelButton = preview.querySelector('bq-button[appearance="secondary"]');
      const confirmButton = preview.querySelector('bq-button[variant="danger"]');
