---
title: Drawer
description: Drawers are off-canvas panels that slide in from a screen edge to show secondary content, navigation, or actions without leaving the current page.
---
