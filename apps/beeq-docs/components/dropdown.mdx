...
<CodeLivePreview code={`
  ...
  <bq-dropdown>
    <bq-button appearance="text" border="full" size="small" slot="trigger">
      <bq-avatar
...
`}>
  <CodeGroup>
    ...
    <BqDropdown>
      <BqButton appearance="text" border="full" size="small" slot="trigger">
        <BqAvatar
...
`}>
  <CodeGroup>
    ...
    <BqDropdown same-width panel-height="16rem">
      <BqButton slot="trigger">
        Choose a region
        <BqIcon name="caret-down" slot="suffix" />
      </BqButton>
