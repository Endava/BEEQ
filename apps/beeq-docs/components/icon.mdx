...
<Note>
  ...
  You can find more details about configuring the icon base path according to your project setup and build tool in the [Getting Started → For developers](/getting-started/for-developers) guide.
</Note>
