...
<CodeLivePreview
  ...
  <style>
    ...
    <bq-page-title>
      ...
      <div slot="sub-title">Sub-title</div>
      <div slot="suffix">
        <bq-icon name="pencil-simple" weight="bold" color="text--brand" title="Edit"></bq-icon>
        <bq-icon name="download-simple" weight="bold" color="text--brand" title="Download"></bq-icon>
      </div>
    </bq-page-title>
  `}
>
  <CodeGroup>
    ...
    <BqPageTitle>
      ...
      <div slot="sub-title">Sub-title</div>
      <div slot="suffix">
        <BqIcon name="pencil-simple" weight="bold" color="text--brand" title="Edit" />
        <BqIcon name="download-simple" weight="bold" color="text--brand" title="Download" />
      </div>
    </BqPageTitle>
    ```
