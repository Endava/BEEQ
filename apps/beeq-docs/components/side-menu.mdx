...
<Frame className="px-4 py-4" caption="Side Menu overview">
  <img
    ...
    alt="Placeholder for the Side Menu overview image"
    style={{ height: "260px", width: "520px" }}
  />
</Frame>
...
<Frame className="px-4 py-4" caption="Side Menu anatomy">
  <img
    src="https://placeholdit.com/1000x420"
    alt="Placeholder for the Side Menu anatomy image"
...
<script>
  (() => {
    ...
    const resetBodyClasses = () => document.body.classList.remove(...bodyClasses);
...
|---|---|
| `default` | The standard side menu appearance |
| `brand` | A brand-colored side menu used when navigation should carry stronger product identity |
| `inverse` | An inverse side menu used on darker or higher-contrast surfaces |
...
<Expandable title="CSS variables" defaultOpen={true}>
  ...
  |---|---|---|
  | `--bq-side-menu--bg-color` | Side menu background color | `theme(backgroundColor.ui.primary)` |
  | `--bq-side-menu--brand-color` | Side menu logo color | `theme(backgroundColor.ui.brand)` |
  | `--bq-side-menu--border-color` | Side menu border color | `theme(stroke.primary)` |
  | `--bq-side-menu--footer-box-shadow` | Side menu footer box shadow | `0 -10px 12px -12px var(--bq-background--tertiary)` |
  | `--bq-side-menu-item--bg-default` | Side menu item default background color | `theme(backgroundColor.transparent)` |
  | `--bq-side-menu-item--bg-active` | Side menu item active background color | `theme(backgroundColor.ui.brand-alt)` |
  | `--bq-side-menu-item--text-default` | Side menu item default text color | `theme(textColor.primary)` |
  | `--bq-side-menu-item--text-active` | Side menu item active text color | `theme(textColor.brand)` |
  | `--bq-side-menu-item--paddingX` | Side menu item horizontal padding | `theme(space.l)` |
  | `--bq-side-menu-item--paddingY` | Side menu item vertical padding | `theme(space.m)` |
