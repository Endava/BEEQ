...
| `--bq-side-menu--width` | Side menu width when expanded (declared on `:root`) | `16rem` |
| `--bq-side-menu--width-collapse` | Side menu width when collapsed (declared on `:root`) | `4.5rem` |
