---
title: Slider
description: Slider lets users pick a single value or numeric range by dragging a handle along a horizontal track for volume, filters, and stepped inputs.
---
