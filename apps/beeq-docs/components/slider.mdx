---
title: Slider
description: Sliders let users pick a value or range by dragging a handle along a horizontal track, useful for volume, brightness, price, and similar controls.
---
