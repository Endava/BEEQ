...
<CodeLivePreview code={`<bq-spinner></bq-spinner>`}>
  <CodeGroup>
...
<CodeLivePreview code={`<bq-spinner size="small"></bq-spinner>`}>
  <CodeGroup>
    ```html HTML icon="html5"
...
<CodeLivePreview code={`<bq-spinner size="large"></bq-spinner>`}>
  <CodeGroup>
    ```html HTML icon="html5"
...
<CardGroup cols={2}>
  <Card horizontal title="Interactive playground" icon="code" href="https://storybook.beeq.design/?path=/story/components-spinner--default">
