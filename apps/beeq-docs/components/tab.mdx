---
title: Tab
description: Tabs organize related content into separate panels under a single view, letting users switch between sections without navigating away from the page.
---
