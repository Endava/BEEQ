...
The current BEEQ spacing scale is exposed as CSS custom properties and Tailwind spacing keys. The same scale powers padding, margin, gap, and BEEQ logical spacing utilities.

| Token | CSS variable | Tailwind key | Value |
| --- | --- | --- | --- |
| `xs3` | `--bq-spacing-xs3` | `xs3` | `2px` |
| `xs2` | `--bq-spacing-xs2` | `xs2` | `4px` |
| `xs` | `--bq-spacing-xs` | `xs` | `8px` |
| `s` | `--bq-spacing-s` | `s` | `12px` |
| `m` | `--bq-spacing-m` | `m` | `16px` |
| `l` | `--bq-spacing-l` | `l` | `24px` |
| `xl` | `--bq-spacing-xl` | `xl` | `32px` |
| `xxl` | `--bq-spacing-xxl` | `xxl` | `40px` |
| `xxl2` | `--bq-spacing-xxl2` | `xxl2` | `56px` |
| `xxl3` | `--bq-spacing-xxl3` | `xxl3` | `64px` |
| `xxl4` | `--bq-spacing-xxl4` | `xxl4` | `72px` |
...
<CodeLivePreview mode="iframe" height="28rem" removePadding code={`
  ...
  <div class="spacing-scale" aria-label="Representative BEEQ spacing values">
    <div class="spacing-row">
      ...
      <span class="spacing-value">2px</span>
    </div>
    <div class="spacing-row">
      <strong>xs</strong>
    ...
    <div class="spacing-row">
      ...
      <span class="spacing-value">56px</span>
    </div>
    <div class="spacing-row">
      <strong>xxl4</strong>
      <span class="spacing-bar spacing-bar--xxl4"></span>
      <span class="spacing-value">72px</span>
    </div>
  </div>
`}>
  <CodeGroup>
