...
<Frame className="px-4 py-4" caption="BEEQ typography overview">
  <img
    ...
    src="/foundations/images/typography/typography-overview-light.svg"
    alt="BEEQ typography overview - light mode"
  />
  <img
    className="hidden dark:block"
    src="/foundations/images/typography/typography-overview-dark.svg"
...
<Frame className="px-4 py-4" caption="Typography hierarchy">
  <img
    className="block dark:hidden"
    src="/foundations/images/typography/typography-hierarchy-light.svg"
    alt="Typography hierarchy - light mode"
  />
  <img
    className="hidden dark:block"
    src="/foundations/images/typography/typography-hierarchy-dark.svg"
...
<Frame className="px-4 py-4" caption="Line height">
  <img
    className="block dark:hidden"
    src="/foundations/images/typography/typography-line-height-light.svg"
    alt="Line height - light mode"
  />
  <img
    className="hidden dark:block"
    src="/foundations/images/typography/typography-line-height-dark.svg"
...
<Frame className="px-4 py-4" caption="Line length">
  <img
    className="block dark:hidden"
    src="/foundations/images/typography/typography-line-length-light.svg"
    alt="Line length - light mode"
  />
  <img
    className="hidden dark:block"
    src="/foundations/images/typography/typography-line-length-dark.svg"
