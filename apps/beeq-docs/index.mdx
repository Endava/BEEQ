...
<div className="relative overflow-hidden px-4 sm:px-6 bq-home-hero">
  ...
  <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center">
    ...
    <div>
      ...
      <p className="text-base lg:text-lg leading-relaxed mb-7 bq-home-section__copy bq-home-section__copy--46">
...
<div className="px-6 py-14 bq-home-setup bq-home-band bq-home-band--tinted">
  <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
    ...
    <div className="lg:pt-2">
      ...
      <p className="text-base leading-relaxed mb-4 mt-0 bq-home-section__copy bq-home-section__copy--44">
      ...
      <p className="text-base leading-relaxed mb-6 mt-0 bq-home-section__copy bq-home-section__copy--44">
...
<div className="px-6 py-14 bq-home-showcase">
  <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
    ...
    <div className="bq-home-showcase__copy">
      ...
      <p className="text-base bq-home-section__copy bq-home-section__copy--52">
...
<div className="px-6 py-14 bq-home-stats bq-home-band bq-home-band--tinted">
  <div className="max-w-6xl mx-auto">
    ...
    <p className="text-base mb-12 bq-home-section__copy bq-home-section__copy--52">
    ...
    <div
      className="grid grid-cols-1 sm:grid-cols-2 rounded-2xl overflow-hidden border bq-home-stats__grid"
    >
      <div className="p-10 border-b border-r bq-home-stats__item">
        <p className="text-xs font-bold uppercase tracking-widest mb-3 mt-0 flex items-center gap-1.5 bq-home-stats__eyebrow">
          <Icon icon="layer-group" /> Consistency
        </p>
        <span className="block text-7xl font-black leading-none mb-3 bq-home-stats__value">ONE</span>
        <p className="text-base font-bold mb-1 mt-0">Source of truth, every product</p>
        <p className="text-sm mt-0 bq-home-section__copy">
      ...
      <div className="p-10 border-b bq-home-stats__item">
        <p className="text-xs font-bold uppercase tracking-widest mb-3 mt-0 flex items-center gap-1.5 bq-home-stats__eyebrow">
          <Icon icon="bolt" /> Efficiency
        </p>
        <span className="block text-7xl font-black leading-none mb-3 bq-home-stats__value bq-home-stats__value--blue">5min</span>
      ...
      <div className="p-10 border-r bq-home-stats__item">
        <p className="text-xs font-bold uppercase tracking-widest mb-3 mt-0 flex items-center gap-1.5 bq-home-stats__eyebrow">
          <Icon icon="palette" /> Scalability
        </p>
        <span className="block text-7xl font-black leading-none mb-3 bq-home-stats__value bq-home-stats__value--purple">∞</span>
      ...
      <div className="p-10">
        ...
        <span className="block text-7xl font-black leading-none mb-3 bq-home-stats__value bq-home-stats__value--green">AA</span>
...
<div className="px-6 py-14 bq-home-comparison">
  <div className="max-w-6xl mx-auto">
    ...
    <p className="text-base mb-10 bq-home-section__copy bq-home-section__copy--52">
