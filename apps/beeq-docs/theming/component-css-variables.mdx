...
For a practical overview of all three customization techniques — shadow DOM parts, global token overrides, and component variables — see [Styles](/usage-guides/customizations/styles).
