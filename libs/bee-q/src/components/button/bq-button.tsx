...
export class BqButton {
  ...
  @Watch('variant')
  checkPropValues() {
    validatePropValue(BUTTON_APPEARANCE, BUTTON_APPEARANCE[0], this.appearance, 'appearance', this.el);
    validatePropValue(BUTTON_TYPE, BUTTON_TYPE[0], this.type, 'type', this.el);
    validatePropValue(BUTTON_SIZE, BUTTON_SIZE[1], this.size, 'size', this.el);
    validatePropValue(BUTTON_VARIANT, BUTTON_VARIANT[0], this.variant, 'variant', this.el);
  }
