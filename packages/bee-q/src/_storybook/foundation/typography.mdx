...
<div data-theme="light" className="rounded-xs border border-solid border-stroke-success bg-ui-success-alt p-m">
  **💡 NOTE:**
...
<div data-theme="light" className="rounded-xs border border-solid border-stroke-warning bg-ui-warning-alt p-m">
