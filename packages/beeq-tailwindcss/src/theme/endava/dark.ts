export const EndavaDarkTheme = {
  ...
  'bq-icon--brand-hover': 'var(--bq-endava-orange-500)', // not found in root
  'bq-icon--brand-active': 'var(--bq-brand)', // probably need to remove
  'bq-icon--brand-disabled': 'var(--bq-endava-orange-700)', // not foud in root
  /** Feedback */
  ...
  'bq-stroke--brand-hover': 'var(--bq-endava-orange-400)', // not found in root
  'bq-stroke--brand-active': 'var(--bq-endava-orange-600)', // not found in root - probably removed
  'bq-stroke--brand-disabled': 'var(--bq-endava-orange-700)', // not found in root
  ...
  'bq-text--brand-hover': 'var(--bq-endava-orange-500)', // not found in root
  'bq-text--brand-active': 'var(--bq-endava-orange-600)', // not found in root - remove all of these
  'bq-text--brand-disabled': 'var(--bq-endava-orange-700)', // not found in root
  /** Feedback */
  ...
  'bq-ui--brand-hover': 'var(--bq-endava-orange-800)', // not found in root
  'bq-ui--brand-active': 'var(--bq-endava-orange-700)', // not found in root
  'bq-ui--brand-disabled': 'var(--bq-endava-orange-900)', // not found in root
  'bq-ui--brand-alt': 'var(--bq-brand-dark)',
  /** Success */
  'bq-ui--success': 'var(--bq-success)',
  'bq-ui--success-hover': 'var(--bq-teal-700)', // not foudn in root
  'bq-ui--success-active': 'var(--bq-teal-800)', // not found in root - remove all of these
  ...
  'bq-ui--warning-active': 'var(--bq-gold-800)', // not foudn in root
