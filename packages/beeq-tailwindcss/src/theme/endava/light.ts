export const EndavaLightTheme = {
  ...
  'bq-icon--brand-active': 'var(--bq-endava-orange-700)', // not found in root
  'bq-icon--brand-disabled': 'var(--bq-endava-orange-400)', // not found in root
  /** Feedback */
  ...
  'bq-stroke--brand-hover': 'var(--bq-endava-orange-500)', // not found in root
  'bq-stroke--brand-active': 'var(--bq-endava-orange-700)', // not found in root
  'bq-stroke--brand-disabled': 'var(--bq-endava-orange-400)', // not found in root
  ...
  'bq-text--brand-active': 'var(--bq-endava-orange-700)', // not found in root
  'bq-text--brand-disabled': 'var(--bq-endava-orange-400)', // not found in root
  /** Feedback */
  ...
  'bq-ui--brand-hover': 'var(--bq-endava-orange-500)', // not found in root
  'bq-ui--brand-active': 'var(--bq-endava-orange-700)', // not found in root
  'bq-ui--brand-disabled': 'var(--bq-endava-orange-400)', // not found in root
