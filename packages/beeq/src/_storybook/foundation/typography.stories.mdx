...
<Meta title="Foundation/Typography" parameters={{
  ...
  docs: {
    container: ({ context }) => {
      ...
      const fontUrl = `https://fonts.google.com/specimen/${globals.theme.toLowerCase() === 'beeq' ? 'Outfit' : 'Poppins'}`

      return (
        <DocsContainer context={context}>
          <div className="bq-doc__wrapper" bq-theme={globals.theme.toLowerCase() ?? 'beeq'} bq-mode={globals.mode.toLowerCase() ?? 'light'}>
            <div className="bq-doc__container">
              ...
              <p>
                <strong>Font:</strong>{' '}
                <a className="bq-link text-text-brand" href={fontUrl}>
                  {globals.theme.toLowerCase() === 'beeq' ? 'Outfit' : 'Poppins'}
                </a>
              </p>
