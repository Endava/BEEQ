import { DocsContainer, Meta, Source, Typeset } from '@storybook/blocks';

<Meta title="Foundation/Typography" parameters={{
  previewTabs: {
    canvas: { hidden: true },
  },
  docs: {
    container: ({ context }) => {
      const { globals} = context.store.globals
      ...
      return (
        <DocsContainer context={context}>
          <div className="flex min-h-[100vh] w-full justify-center bg-bg-primary pt-xl" data-theme={globals.theme.toLowerCase() ?? 'light'}>
            <div className="container mx-auto px-l font-outfit text-m text-text-primary">
              <h1>Typography</h1>
              ...
              <p><strong>Font:</strong> <a className="bq-link text-text-brand" href="https://fonts.google.com/specimen/Outfit">Outfit</a></p>
              ...
              <div className="rounded-xs border border-solid border-stroke-success bg-ui-success-alt p-m">
                <strong>💡 NOTE:</strong>
                <p>
              ...
              <div className="rounded-xs border border-solid border-stroke-warning bg-ui-warning-alt p-m">
