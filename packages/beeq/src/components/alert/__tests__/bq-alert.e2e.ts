...
describe('bq-alert', () => {
  ...
  it('should render as hidden with `open="false"`', async () => {
    const page = await newE2EPage();
    await page.setContent('<bq-alert open="false"></bq-alert>');
  ...
  it('should render as open', async () => {
    const page = await newE2EPage();
    await page.setContent('<bq-alert open></bq-alert>');
  ...
  it('should render as open with `open="true"`', async () => {
    const page = await newE2EPage();
    await page.setContent('<bq-alert open="true"></bq-alert>');
  ...
  it('should show alert with icon', async () => {
    const page = await newE2EPage();
    await page.setContent(`
      <bq-alert type="info">Alert title</bq-alert>
    `);
