...
describe('bq-alert', () => {
  it('should render', async () => {
    const page = await newE2EPage({ html: `<bq-alert></bq-alert>` });
  ...
  it('should render as hidden with `open="false"`', async () => {
    const page = await newE2EPage({ html: `<bq-alert open="false"></bq-alert>` });
  ...
  it('should render as open', async () => {
    const page = await newE2EPage({ html: `<bq-alert open></bq-alert>` });
  ...
  it('should render as open with `open="true"`', async () => {
    const page = await newE2EPage({ html: `<bq-alert open="true"></bq-alert>` });
  ...
  it('should show alert with icon', async () => {
    const page = await newE2EPage({ html: `<bq-alert type="info">Alert title</bq-alert>` });
