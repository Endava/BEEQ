...
| `formatOptions`         | --                        | Numeric options used to derive the input mask's field order and separators.  The options must contain numeric or two-digit day/month fields and a numeric year. Textual or variable-length fields fall back to the locale numeric mask and emit a development warning.                                                                                                                                                                                          | `DateTimeFormatOptions`                                                                                                                                              | `undefined`       |
...
| `placeholder`           | `placeholder`             | <span style="color:red">**[DEPRECATED]**</span> Locale-derived segment format hints always describe the expected entry layout, so this value no longer changes the rendered field.<br/><br/>                                                                                                                                                                                                                                                                    | `string`                                                                                                                                                             | `undefined`       |
...
| `"input"`                    | The segmented date field group.                                       |
| `"label"`                    | The label slot container.                                             |
| `"panel"`                    | The dropdown panel container.                                         |
| `"prefix"`                   | The prefix slot container.                                            |
| `"segment"`                  | An editable day, month, or year segment.                              |
| `"segment-literal"`          | A locale-derived separator between date segments.                     |
