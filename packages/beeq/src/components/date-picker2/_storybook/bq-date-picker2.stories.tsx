  ...
  render: (args) => html`
    <div class="grid grid-cols-1 gap-m sm:grid-cols-3">
      ...
      <div class="flex flex-col gap-2">
        ...
        ${Template({ ...args, value: '2026-05-25', name: 'bq-date-picker2-default', noLabel: true })}
      </div>
      <!-- Range -->
      <div class="flex flex-col gap-2">
