...
| `enableTooltip` | `enable-tooltip` | If `true`, the progress bar will be displayed with percentage tooltip  | `boolean`               | `false`     |
| `indeterminate` | `indeterminate`  | If `true` the indeterminate state of progress bar is enabled           | `boolean`               | `false`     |
| `label`         | `label`          | If `true`, the progress bar will be displayed with percentage text     | `boolean`               | `false`     |
