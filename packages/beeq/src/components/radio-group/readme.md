...
| ------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | ------------ |
| `backgroundOnHover` | `background-on-hover` | If true, all radio inputs in the group will display a background on hover                                                 | `boolean \| undefined`       | `false`      |
...
| `disabled`          | `disabled`            | If true radio inputs are disabled                                                                                         | `boolean \| undefined`       | `false`      |
| `fieldset`          | `fieldset`            | If true displays fieldset                                                                                                 | `boolean \| undefined`       | `false`      |
...
| `value`             | `value`               | A string representing the value of the radio.                                                                             | `string \| undefined`        | `undefined`  |
