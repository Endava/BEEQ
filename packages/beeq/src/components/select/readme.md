...
| `disableScrollLock`     | `disable-scroll-lock`     | If true, the Select panel will not lock the page body scroll when open.                                                                                                                                  | `boolean`                                                                                                                                                            | `false`         |
...
| `enableCheckboxes`      | `enable-checkboxes`       | If true, flat options render with checkboxes when multiple selection is enabled. Nested multi-select options always render with checkboxes.                                                              | `boolean`                                                                                                                                                            | `undefined`     |
...
| `readonly`              | `readonly`                | <span style="color:red">**[DEPRECATED]**</span> Use `disableSearch` to allow selection without text filtering. In a future major release, `readonly` will prevent changing the selected value.<br/><br/> | `boolean`                                                                                                                                                            | `undefined`     |
