...
| ------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `backgroundOnHover` | `background-on-hover` | If true, a background will be displayed on hover                                                                                                            | `boolean \| undefined`                                                                                                                                                                                   | `false`     |
| `checked`           | `checked`             | It indicates whether if the switch is `ON` by default (when the page loads)                                                                                 | `boolean \| undefined`                                                                                                                                                                                   | `false`     |
| `disabled`          | `disabled`            | If true, the switch control will be disabled and no interaction will be allowed                                                                             | `boolean \| undefined`                                                                                                                                                                                   | `false`     |
| `fullWidth`         | `full-width`          | If true, the component will take the full width space available on the parent container                                                                     | `boolean \| undefined`                                                                                                                                                                                   | `false`     |
| `innerLabel`        | `inner-label`         | It indicates how to to display the on/off marks inside the control, with icons or none (default)                                                            | `"default" \| "icon" \| undefined`                                                                                                                                                                       | `'default'` |
...
| `required`          | `required`            | If `true`, it will indicate that the user must switch `ON` the element before the owning form can be submitted                                              | `boolean \| undefined`                                                                                                                                                                                   | `false`     |
| `reverseOrder`      | `reverse-order`       | If true, the order of the control and the label text will be changed                                                                                        | `boolean \| undefined`                                                                                                                                                                                   | `false`     |
| `value`             | `value`               | The input control's value, submitted as a name/value pair with form data.                                                                                   | `string \| undefined`                                                                                                                                                                                    | `undefined` |
