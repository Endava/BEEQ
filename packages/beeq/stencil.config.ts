...
export const config: Config = {
  ...
  outputTargets: [
    ...
    /**
     * The output custom-elements.json file is generated via Custom Elements Manifest.
     * !Please, notice that this file is slightly different from the one generated by the Stencil compiler.
     * @see packages/beeq/custom-elements.json
     */
    { type: 'docs-vscode', file: './.cem/custom-elements.json' },
    {
      type: 'dist',
      copy: [
